class KeyBindings:
    ...
    def fillWithDefault(self):
        self.key_bindings['toggle-help'] = ['ctrl h']
        self.key_bindings['quit'] = ['ctrl q']
        self.key_bindings['toggle-toolbar'] = ['ctrl t']
        # self.key_bindings['toggle-borders'] = ['b']
        self.key_bindings['toggle-wrapping'] = ['ctrl w']
        # self.key_bindings['save'] = ['S']
        self.key_bindings['reload'] = ['ctrl r']
        ...
        self.key_bindings['edit-save'] = ['ctrl s']
